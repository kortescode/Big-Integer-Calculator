...
# 182 "parser.ml"
    ...
    | MenhirState7 ->
        ...
        let _v : 'tv_expr = 
# 16 "parser.mly"
                  ( Arithexpr.ArithExpr.mul(_1, _3) )
# 202 "parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v) : 'freshtv36)) : 'freshtv38)
    | MenhirState9 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        ...
        let _v : 'tv_expr = 
# 18 "parser.mly"
                     ( Arithexpr.ArithExpr.modulo(_1, _3) )
# 215 "parser.ml"
         in
...
# 251 "parser.ml"
    ...
    | MenhirState0 ->
        ...
        | EOL ->
            ...
            let _v : (
# 6 "parser.mly"
      (Arithexpr.ArithExpr.arith_expr)
# 281 "parser.ml"
            ) = 
# 9 "parser.mly"
                ( _1 )
